...
const buttonVariants = cva(
  'active:scale-95 inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 disabled:opacity-50 dark:focus:ring-slate-400 disabled:pointer-events-none dark:focus:ring-offset-slate-900',
  {
    variants: {
      variant: {
        default:
          'bg-zinc-900 text-zinc-100 hover:bg-zinc-700 hover:ring-2 transition ring-zinc-800 ring-offset-2',
        slight:
          'bg-zinc-900 text-zinc-100 hover:bg-zinc-700 transition',
        destructive: 'text-white hover:bg-red-600 dark:hover:bg-red-600 hover:ring-2 transition ring-red-600 ring-offset-2',
        outline:
